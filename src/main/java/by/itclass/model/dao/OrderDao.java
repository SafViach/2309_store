...
public class OrderDao {
    ...
    public static final String INSERT_ORDER_ITEM = "INSERT INTO orderItem(orderId , itemType , itemId ," +
    ...
    public static OrderDao getInstance() {
        return dao == null ? dao = new OrderDao() : dao;
//        if(dao == null){
//            dao = new OrderDao();
//        }
//        return dao;
    ...
    private void firstAction(String orderId, String date, int userId, String address, PreparedStatement ps) throws SQLException {
